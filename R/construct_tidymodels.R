...
#.expand_recipes_step_b <- function(x){
#   out <- sub(x = x[2],
#             pattern = x[2],
#            replacement = switch(x[2],
#                                "b" = "BoxCox", # bagimpute, bin2factor, bs
...
#' Function to translate abbreviation starting with \code{pretty} into formatted
#' character string.
#'
#' @param x character vector, maximum length 2.
#' @return full length character string of input.
