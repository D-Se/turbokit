...
-   *Tidymath*: Shorthand notation for writing chains of functions in a pipe format.

-   *Superpipe*: `%>>%` operator to convert tidymath instructions to a full-length snippet.
...
Besides the two pipe operators, all of the output of the insert\_ functions, can be achieved through tidymath and superpipe combination as well as the turbo function. It is thus recommended to only bind those functions that the user very frequently uses.
