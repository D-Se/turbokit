...
The following features have their own vignette

*Tidymath* - `vignette(tidymath)`

*Dynamic snippets* - `vignette(tidymath)`

*Quasi-comment -* `vignette(tidymath)`

Finally, a brief introduction to the whole game

![](images/vignette.gif)

# Setup turbokit

The remainder of this vignette focuses on setting up turbokit to your preferences.
